    ...
    <body>
        ...
        <div class="row container" style="padding-top: 50px">
            ...
            <form action="projetos" method="POST" class="col s6">
                ...
                <button class="btn waves-effect waves-light" type="submit" name="action">Acessar conta
                    <i class="material-icons right">send</i>
                </button>
                <div>
                    <c:if test="${not empty mensagem}">
                        <h6>
                            <strong class="red-text text-darken-2"> ${mensagem}</strong><br>Verifique as informações e tente novamente...
                        </h6>
                    </c:if>
                </div>
                <p>Não possui uma conta? <a href="cadastrarUsuario.jsp">Cadastrar uma conta</a></p>
            </form>
            <div class="col s3"></div>
        </div>
